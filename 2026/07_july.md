...
### 7月12日 
【やったこと】<br>
World Holy Compass:サーボが正しい方向を向かない不具合の修正

【学び・Why】<br>
矢印(サーボ)が聖地ごとに同じ方向を向く/回らない/変な音が鳴るという不具合が発生。原因を切り分けて修正した。<br>

ESP32Servoにマイナス角度を渡すと正しく回らないことが判明。方位角を0〜360度のままサーボに渡す方式に変更した<br>
スピーカー用とサーボ用のPWM初期化の順番が悪く、内部でリソースが競合していた。サーボを先にattachする順に直したら、異音も動作不良も解消した<br>
サーボホーンの取り付け角度が実測とズレていたため、オフセット値を入れて補正した<br>
